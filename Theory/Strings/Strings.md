...
To prevent this java has StringBuilder class 
The StringBuilder class is mutable so when we perform the above operation we could use the string builder class
